...
function make_albums(name, title, tracks) {
    let album = {
        artist_name: name,
        album_title: title,
        tracks: tracks
...
/* Problem# 45*/
console.log("\n\nProblem 45\n");
function car(manufacturer, modelName, color = "NA", features = "NA") {
    let car = {
